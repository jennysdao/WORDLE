...
function revealWord(guess) {
    ...
    const secret = state.secret.toLowerCase();
    ...
    const isWinner = secret === guess.toLowerCase();
    ...
    if (isWinner) {
        ...
        alert(`Nice try, the word was ${state.secret}.`);
